...
const Footer = () => {
  return (
    <footer className="w-full flex justify-center bg-primary-400">
      <div
        className={classNames(
          "max-w-7xl sm:px-16 w-full flex justify-between sm:flex-nowrap flex-wrap gap-x-4 gap-y-8 items-center px-8 py-8 z-50"
        )}
      >
        <div className="w-full flex flex-col gap-4">
          ...
          <p className="text-sm text-primary-100 font-normal">
            Premium fashion for the modern lifestyle. Quality craftsmanship
            meets contemporary design.
          </p>
          <div className="space-y-1">
            <p className="text-sm text-natural-100 font-medium w-fit">
              support@wavin.shop
            </p>
            <p className="text-sm text-natural-100 font-medium w-fit">
              +966 55 123 4567
